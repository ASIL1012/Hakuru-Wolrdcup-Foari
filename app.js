...
const goalscorerPlayers = [
    // France (2026 World Cup Squad)
    { id: 1, name: "Kylian Mbappé", team: "France", flag: "https://flagcdn.com/fr.svg" },
    { id: 3, name: "Bradley Barcola", team: "France", flag: "https://flagcdn.com/fr.svg" },
    { id: 4, name: "Ousmane Dembélé", team: "France", flag: "https://flagcdn.com/fr.svg" },
    { id: 5, name: "Michael Olise", team: "France", flag: "https://flagcdn.com/fr.svg" },
    { id: 6, name: "Marcus Thuram", team: "France", flag: "https://flagcdn.com/fr.svg" },
    { id: 7, name: "Jean-Philippe Mateta", team: "France", flag: "https://flagcdn.com/fr.svg" },
    { id: 8, name: "Maghnes Akliouche", team: "France", flag: "https://flagcdn.com/fr.svg" },
    { id: 9, name: "Rayan Cherki", team: "France", flag: "https://flagcdn.com/fr.svg" },
    { id: 10, name: "Désiré Doué", team: "France", flag: "https://flagcdn.com/fr.svg" },
    { id: 11, name: "N'Golo Kanté", team: "France", flag: "https://flagcdn.com/fr.svg" },
    { id: 12, name: "Manu Koné", team: "France", flag: "https://flagcdn.com/fr.svg" },
    { id: 13, name: "Adrien Rabiot", team: "France", flag: "https://flagcdn.com/fr.svg" },
    { id: 14, name: "Aurélien Tchouaméni", team: "France", flag: "https://flagcdn.com/fr.svg" },
    { id: 15, name: "Warren Zaïre-Emery", team: "France", flag: "https://flagcdn.com/fr.svg" },
    { id: 16, name: "William Saliba", team: "France", flag: "https://flagcdn.com/fr.svg" },
    { id: 17, name: "Dayot Upamecano", team: "France", flag: "https://flagcdn.com/fr.svg" },
    { id: 18, name: "Theo Hernandez", team: "France", flag: "https://flagcdn.com/fr.svg" },
    { id: 19, name: "Ibrahima Konaté", team: "France", flag: "https://flagcdn.com/fr.svg" },
    { id: 20, name: "Jules Koundé", team: "France", flag: "https://flagcdn.com/fr.svg" },
    { id: 21, name: "Lucas Hernandez", team: "France", flag: "https://flagcdn.com/fr.svg" },
    { id: 22, name: "Malo Gusto", team: "France", flag: "https://flagcdn.com/fr.svg" },
    { id: 23, name: "Lucas Digne", team: "France", flag: "https://flagcdn.com/fr.svg" },
    { id: 24, name: "Maxence Lacroix", team: "France", flag: "https://flagcdn.com/fr.svg" },
    { id: 25, name: "Mike Maignan", team: "France", flag: "https://flagcdn.com/fr.svg" },
    { id: 26, name: "Brice Samba", team: "France", flag: "https://flagcdn.com/fr.svg" },
    
    // Morocco (2026 World Cup Squad)
    { id: 30, name: "Brahim Díaz", team: "Morocco", flag: "https://flagcdn.com/ma.svg" },
    { id: 31, name: "Achraf Hakimi", team: "Morocco", flag: "https://flagcdn.com/ma.svg" },
    { id: 32, name: "Youssef En-Nesyri", team: "Morocco", flag: "https://flagcdn.com/ma.svg" },
    { id: 33, name: "Hakim Ziyech", team: "Morocco", flag: "https://flagcdn.com/ma.svg" },
    { id: 34, name: "Ayoub El Kaabi", team: "Morocco", flag: "https://flagcdn.com/ma.svg" },
    { id: 35, name: "Soufiane Rahimi", team: "Morocco", flag: "https://flagcdn.com/ma.svg" },
    { id: 36, name: "Bilal El Khannouss", team: "Morocco", flag: "https://flagcdn.com/ma.svg" },
    { id: 37, name: "Azzedine Ounahi", team: "Morocco", flag: "https://flagcdn.com/ma.svg" },
    { id: 38, name: "Ismael Saibari", team: "Morocco", flag: "https://flagcdn.com/ma.svg" },
    { id: 39, name: "Sofyan Amrabat", team: "Morocco", flag: "https://flagcdn.com/ma.svg" },
    { id: 40, name: "Chadi Riad", team: "Morocco", flag: "https://flagcdn.com/ma.svg" },
    { id: 41, name: "Noussair Mazraoui", team: "Morocco", flag: "https://flagcdn.com/ma.svg" },
    { id: 42, name: "Nayef Aguerd", team: "Morocco", flag: "https://flagcdn.com/ma.svg" },
    { id: 43, name: "Ayyoub Bouaddi", team: "Morocco", flag: "https://flagcdn.com/ma.svg" },
    { id: 44, name: "Benjamin Bouchouari", team: "Morocco", flag: "https://flagcdn.com/ma.svg" },
    { id: 45, name: "Issa Diop", team: "Morocco", flag: "https://flagcdn.com/ma.svg" },
    { id: 46, name: "Zakaria El Ouahdi", team: "Morocco", flag: "https://flagcdn.com/ma.svg" },
    { id: 47, name: "Youssef Belammari", team: "Morocco", flag: "https://flagcdn.com/ma.svg" },
    { id: 48, name: "Yassine Bounou (Bono)", team: "Morocco", flag: "https://flagcdn.com/ma.svg" },
    { id: 49, name: "Munir Mohamedi", team: "Morocco", flag: "https://flagcdn.com/ma.svg" },
    { id: 50, name: "Amine Sbaï", team: "Morocco", flag: "https://flagcdn.com/ma.svg" },

    // Special
    { id: 99, name: "No Goalscorer / Own Goal", team: "Special", flag: "https://flagcdn.com/un.svg" }
];

let selectedGoalscorerId = null;

function openGoalscorerModal() {
    const modal = document.getElementById('goalscorer-modal');
    const searchInput = document.getElementById('goalscorer-search');
    ...
    const gsPred = userState.predictions[970] || { home: '', away: '' };
    selectedGoalscorerId = gsPred.home ? parseInt(gsPred.home) : null;
    
    renderGoalscorerPlayersList('');
    
    modal.style.display = 'flex';
    
    searchInput.oninput = (e) => {
        renderGoalscorerPlayersList(e.target.value);
    };
}

function renderGoalscorerPlayersList(filterText) {
    const listContainer = document.getElementById('goalscorer-list');
    const confirmBtn = document.getElementById('goalscorer-confirm-btn');
    if (!listContainer) return;
    
    listContainer.innerHTML = '';
    const query = filterText.toLowerCase().trim();
    
    const filtered = goalscorerPlayers.filter(p => p.name.toLowerCase().includes(query) || p.team.toLowerCase().includes(query));
    
    if (filtered.length === 0) {
        listContainer.innerHTML = '<div style="text-align: center; color: var(--text-muted); padding: 1rem;">No players found</div>';
        return;
    }
    ...
    filtered.forEach(player => {
        ...
        const isSelected = selectedGoalscorerId === player.id;
        if (isSelected) {
            item.style.background = 'rgba(34, 197, 94, 0.15)';
            item.style.border = '1px solid rgba(34, 197, 94, 0.25)';
        ...
        item.onclick = () => {
            ...
            renderGoalscorerPlayersList(filterText);
        };
        
        item.innerHTML = `
            <img src="${player.flag}" style="width: 20px; height: 14px; border-radius: 2px;">
            <span style="font-weight: 500;">${player.name}</span>
            <span style="font-size: 0.75rem; color: var(--text-muted); margin-left: auto;">${player.team}</span>
        `;
...
function setupGoalscorerModalListeners() {
    const modal = document.getElementById('goalscorer-modal');
    const cancelBtn = document.getElementById('goalscorer-cancel-btn');
    const confirmBtn = document.getElementById('goalscorer-confirm-btn');
    ...
    if (confirmBtn) {
        confirmBtn.onclick = () => {
            if (!selectedGoalscorerId) return;
            
            // Save the prediction under Match ID 970
            savePrediction(970, selectedGoalscorerId, 0, null);
            
            // Close the modal
            if (modal) modal.style.display = 'none';
            
            // Re-render matches to update button text
            renderMatches();
        };
    }
}
...
function renderMatches() {
    ...
    const roundOf16Teams = [
        { id: 1, name: "Argentina", flag: "https://flagcdn.com/ar.svg" },
        { id: 2, name: "Belgium", flag: "https://flagcdn.com/be.svg" },
        { id: 3, name: "Brazil", flag: "https://flagcdn.com/br.svg" },
        { id: 4, name: "Canada", flag: "https://flagcdn.com/ca.svg" },
        { id: 5, name: "Colombia", flag: "https://flagcdn.com/co.svg" },
        { id: 6, name: "Egypt", flag: "https://flagcdn.com/eg.svg" },
        { id: 7, name: "England", flag: "https://flagcdn.com/gb-eng.svg" },
        { id: 8, name: "France", flag: "https://flagcdn.com/fr.svg" },
        { id: 9, name: "Mexico", flag: "https://flagcdn.com/mx.svg" },
        { id: 10, name: "Morocco", flag: "https://flagcdn.com/ma.svg" },
        { id: 11, name: "Norway", flag: "https://flagcdn.com/no.svg" },
        { id: 12, name: "Paraguay", flag: "https://flagcdn.com/py.svg" },
        { id: 13, name: "Portugal", flag: "https://flagcdn.com/pt.svg" },
        { id: 14, name: "Spain", flag: "https://flagcdn.com/es.svg" },
        { id: 15, name: "Switzerland", flag: "https://flagcdn.com/ch.svg" },
        { id: 16, name: "USA", flag: "https://flagcdn.com/us.svg" }
    ];
    ...
    const cutoffTime = new Date("2026-07-09T20:00:00Z"); // Kickoff of Match 97 (Morocco vs France)
    const isSpecialEventLocked = now.getTime() >= cutoffTime.getTime();

    const winnerPred = userState.predictions[999] || { home: '', away: '' };
    const savedTeamId = winnerPred.home ? parseInt(winnerPred.home) : null;

    if (!isSpecialEventLocked) {
        const winnerCard = document.createElement('div');
        winnerCard.className = 'card match-card special-event-card';

        let selectedTeamHTML = '-- Select Champion Team --';
        let optionsListHTML = '';

        if (savedTeamId) {
            const savedTeam = quarterFinalTeams.find(t => t.id === savedTeamId);
            if (savedTeam) {
                selectedTeamHTML = `
                    <img src="${savedTeam.flag}" class="team-flag" style="width: 20px; height: 14px; border-radius: 2px; vertical-align: middle;">
                    <span>${savedTeam.name}</span>
                `;
            }
        }

        quarterFinalTeams.forEach(team => {
            const isSelectedClass = savedTeamId === team.id ? 'selected' : '';
            optionsListHTML += `
                <div class="custom-option ${isSelectedClass}" data-value="${team.id}">
                    <img src="${team.flag}" class="team-flag" style="width: 20px; height: 14px; border-radius: 2px;">
                    <span>${team.name}</span>
                </div>
            `;
        });

        let savedPickHTML = '<span style="font-style: italic; color: var(--text-muted);">No pick saved yet</span>';
        if (savedTeamId) {
            const savedTeam = roundOf16Teams.find(t => t.id === savedTeamId);
            if (savedTeam) {
                const isEliminated = !quarterFinalTeams.some(t => t.id === savedTeamId);
                const statusText = isEliminated ? ' (ELIMINATED - Pick a new team!)' : '';
                const color = isEliminated ? '#ef4444' : 'var(--secondary)';
                savedPickHTML = `<span style="font-weight: 700; color: ${color};">Your Champion Pick:</span> <img src="${savedTeam.flag}" class="team-flag" style="width: 20px; height: 14px; margin: 0 4px; vertical-align: middle; border-radius: 2px;"> ${savedTeam.name}${statusText}`;
            }
        }

        const formattedDate = cutoffTime.toLocaleDateString(undefined, { month: 'short', day: 'numeric', year: 'numeric' });
        const formattedTime = cutoffTime.toLocaleTimeString(undefined, { hour: '2-digit', minute: '2-digit' });

        let lockStatusHTML = '';
        if (isSpecialEventLocked) {
            lockStatusHTML = `<div class="lock-status past">🔒 Closed (Winner Selection Locked)</div>`;
        } else if (userState.username) {
            lockStatusHTML = `<div class="lock-status open">🟢 Open for Predictions</div>`;
        } else {
            lockStatusHTML = `<div class="lock-status locked">🔒 Please log in to predict</div>`;
        }

        winnerCard.innerHTML = `
            <div class="match-info">🏆 SPECIAL EVENT • World Cup Champion Prediction • Locks ${formattedDate} ${formattedTime}</div>
            <div class="match-main" style="flex-direction: column; align-items: center; gap: 10px; padding: 10px 0; width: 100%;">
                <div class="custom-dropdown" style="position: relative; width: 100%;">
                    <div id="winner-team-select-trigger" class="winner-select" style="width: 100%; padding: 0.75rem; border-radius: 0.75rem; background: var(--surface-color); backdrop-filter: var(--glass-blur); -webkit-backdrop-filter: var(--glass-blur); border: 1px solid var(--border); color: var(--text-main); font-family: inherit; font-size: 1rem; text-align: center; cursor: pointer; outline: none; transition: var(--transition); box-shadow: 0 4px 30px rgba(0, 0, 0, 0.1); display: flex; align-items: center; justify-content: center; gap: 8px;">
                        <div id="trigger-content" style="display: flex; align-items: center; gap: 8px;">
                            ${selectedTeamHTML}
                        </div>
                        <span style="font-size: 0.8rem; opacity: 0.7; margin-left: auto;">▼</span>
                    </div>
                    <div id="winner-team-options-menu" style="display: none; position: absolute; top: calc(100% + 5px); left: 0; right: 0; background: rgba(15, 23, 42, 0.75); backdrop-filter: var(--glass-blur); -webkit-backdrop-filter: var(--glass-blur); border: 1px solid var(--border); border-radius: 0.75rem; box-shadow: 0 10px 25px -5px rgba(0, 0, 0, 0.5), 0 8px 10px -6px rgba(0, 0, 0, 0.5); z-index: 100; max-height: 250px; overflow-y: auto; padding: 4px;">
                        ${optionsListHTML}
                    </div>
                    <input type="hidden" id="winner-team-select" value="${savedTeamId || ''}">
                </div>
            </div>
            <div id="winner-saved-pick" style="text-align: center; margin-bottom: 12px; font-size: 0.95rem;">
                ${savedPickHTML}
            </div>
            <div class="match-countdown" id="countdown-999" style="font-weight:700; color:var(--secondary); font-size:0.85rem; text-align:center; margin-top:8px; display:none;"></div>
            <div class="prediction-status" id="status-999" style="display: none; text-align: center; margin-top: 8px; color: var(--primary); font-weight: 700;">Saved!</div>
            ${(!isSpecialEventLocked && userState.username) ? `<button class="btn confirm-winner-btn" id="confirm-winner-btn" style="width: 100%; margin-top: 0.5rem; margin-bottom: 0.5rem; background: var(--primary); font-weight: 600;">Confirm Champion Pick</button>` : ''}
            ${lockStatusHTML}
        `;

        matchContainer.prepend(winnerCard);

        // Setup custom dropdown logic
        const trigger = winnerCard.querySelector('#winner-team-select-trigger');
        const menu = winnerCard.querySelector('#winner-team-options-menu');
        const hiddenInput = winnerCard.querySelector('#winner-team-select');
        ...
        // Add event listener to confirm button if present and not locked
        if (!isSpecialEventLocked) {
            const confirmBtn = winnerCard.querySelector('#confirm-winner-btn');
            if (confirmBtn) {
                confirmBtn.onclick = () => {
                    const selectEl = document.getElementById('winner-team-select');
                    const val = selectEl.value;
                    if (!val) return;
                    const teamId = parseInt(val);
                    savePrediction(999, teamId, teamId, null);

                    // Show saved status
                    const statusEl = document.getElementById('status-999');
                    if (statusEl) {
                    ...
                    const savedPickEl = document.getElementById('winner-saved-pick');
                    const team = roundOf16Teams.find(t => t.id === teamId);
                    if (savedPickEl && team) {
                        savedPickEl.innerHTML = `<span style="font-weight: 700; color: var(--secondary);">Your Champion Pick:</span> <img src="${team.flag}" class="team-flag" style="width: 20px; height: 14px; margin: 0 4px; vertical-align: middle; border-radius: 2px;"> ${team.name}`;
                    }
                };
            }
        }
    ...
    upcomingMatches.forEach(match => {
        ...
        let goalscorerButtonHTML = '';
        if (match.id === 97) {
            const gsPred = userState.predictions[970] || { home: '', away: '' };
            const savedPlayerId = gsPred.home ? parseInt(gsPred.home) : null;
            const savedPlayer = goalscorerPlayers.find(p => p.id === savedPlayerId);
            
            let btnText = '⚽ PREDICT THE PLAYER TO SCORE THE FIRST GOAL';
            if (savedPlayer) {
                btnText = `⚽ First Goalscorer: ${savedPlayer.name}`;
            }
            
            goalscorerButtonHTML = `
                <button class="btn goalscorer-btn" id="goalscorer-btn-97" style="width: 100%; margin-top: 0.25rem; margin-bottom: 0.5rem; background: linear-gradient(135deg, #1e293b 0%, #0f172a 100%); border: 1px solid var(--border); font-weight: 600; font-size: 0.9rem;" ${isLocked ? 'disabled' : ''}>
                    ${btnText}
                </button>
            `;
        }
        ...
        if (match.id === 97) {
            const btn = card.querySelector('#goalscorer-btn-97');
            if (btn) {
                btn.onclick = () => {
                    if (!userState.username) {
...
function updateCountdowns() {
    ...
    document.querySelectorAll('.match-card').forEach(card => {
        ...
        const select = card.querySelector('#winner-team-select');
        if (!input && !select) return;

        const matchId = input ? parseInt(input.getAttribute('data-match')) : 999;

        if (matchId === 999) {
            const cutoffTime = new Date("2026-07-09T20:00:00Z").getTime();
            const diff = cutoffTime - now.getTime();
            ...
            const confirmBtn = card.querySelector('#confirm-winner-btn');
            if (confirmBtn) {
                const expectedDisplay = (!isSpecialEventLocked && userState.username) ? 'block' : 'none';
            ...
            if (select) {
                if (select.disabled !== isSpecialEventLocked) {
                    select.disabled = isSpecialEventLocked;
                }
            }
            const trigger = card.querySelector('#winner-team-select-trigger');
            if (trigger) {
                if (isSpecialEventLocked) {
            ...
            if (countdownEl) {
                if (diff > 0) {
                    ...
                    const countdownStr = `⏳ End In ${hStr}h ${mStr}m ${sStr}s`;
        ...
        if (matchId === 97) {
            const gsBtn = card.querySelector('#goalscorer-btn-97');
            if (gsBtn) {
                if (gsBtn.disabled !== isLocked) {
                    gsBtn.disabled = isLocked;
                }
            }
        }
...
function updatePoints() {
    ...
    if (username) {
        ...
        const staticR32Entry = staticR32Leaderboard.find(p => p.name.toLowerCase() === username.toLowerCase());
        if (staticR32Entry) {
            r32Pts = staticR32Entry.pts;
        }
        const staticR16Entry = staticR16Leaderboard.find(p => p.name.toLowerCase() === username.toLowerCase());
        if (staticR16Entry) {
            r16Pts = staticR16Entry.pts;
        }
        const staticQFEntry = staticQFLeaderboard.find(p => p.name.toLowerCase() === username.toLowerCase());
        if (staticQFEntry) {
            qfPts = staticQFEntry.pts;
        }
    }

    let total = groupPts + r32Pts + r16Pts + qfPts;
    matches.forEach(match => {
        if (match.id >= 101 && match.result) {
            total += calculateMatchPoints(userState.predictions[match.id], match.result, match.id);
        }
    });
...
function getPointsForAccount(predictions) {
    ...
    matches.forEach(match => {
        if (match.result) {
            total += calculateMatchPoints(predictions[match.id], match.result, match.id);
        }
    });
    return total;
}
...
function getVotedCountForAccount(predictions) {
    ...
    Object.keys(predictions).forEach(matchId => {
        if (parseInt(matchId) === 999) return;
...
function calculateScoreFromRawPredictions(rawPreds, boardType = 'overall') {
    ...
    if (boardType === 'overall') {
        ...
        if (username) {
            ...
            if (staticR32Entry) {
                r32Pts = staticR32Entry.pts;
                r32Voted = staticR32Entry.voted;
            }
            const staticR16Entry = staticR16Leaderboard.find(p => p.name.toLowerCase() === username.toLowerCase());
            if (staticR16Entry) {
                r16Pts = staticR16Entry.pts;
                r16Voted = staticR16Entry.voted;
            }
            const staticQFEntry = staticQFLeaderboard.find(p => p.name.toLowerCase() === username.toLowerCase());
            if (staticQFEntry) {
                qfPts = staticQFEntry.pts;
                qfVoted = staticQFEntry.voted;
            }
        }
        pts = groupPts + r32Pts + r16Pts + qfPts;
        voted = groupVoted + r32Voted + r16Voted + qfVoted;

        rawPreds.forEach(p => {
            const matchId = parseInt(p.match_id);
            if (matchId < 101 || matchId === 999) return;
        ...
        rawPreds.forEach(p => {
            ...
            if (boardType === 'finals' && (matchId < 101 || matchId > 104)) return;
...
const staticR32Leaderboard = [
    { "name": "IyaL", "pts": 25, "voted": 16, "icon": "👑" },
    { "name": "Humaid", "pts": 24, "voted": 16, "icon": "🥈" },
    { "name": "AliAshraf", "pts": 23, "voted": 16, "icon": "🥉" },
    { "name": "Azkaan", "pts": 22, "voted": 16, "icon": "👤" },
    { "name": "Inaa", "pts": 22, "voted": 16, "icon": "👤" },
    { "name": "Azka", "pts": 20, "voted": 16, "icon": "👤" },
    { "name": "Faraa", "pts": 20, "voted": 16, "icon": "👤" },
    { "name": "Asil", "pts": 20, "voted": 16, "icon": "👤" },
    { "name": "Amsoodha", "pts": 19, "voted": 16, "icon": "👤" },
    { "name": "Shafga", "pts": 18, "voted": 15, "icon": "👤" },
    { "name": "Ikleel", "pts": 17, "voted": 16, "icon": "👤" },
    { "name": "Thuhthahtha", "pts": 17, "voted": 16, "icon": "👤" },
    { "name": "Mohamed Ashraf", "pts": 17, "voted": 16, "icon": "👤" },
    { "name": "Shahuma", "pts": 16, "voted": 16, "icon": "👤" },
    { "name": "Elaf", "pts": 16, "voted": 16, "icon": "👤" },
    { "name": "Hameed", "pts": 16, "voted": 14, "icon": "👤" },
    { "name": "Nasy", "pts": 14, "voted": 13, "icon": "👤" },
    { "name": "klsm", "pts": 13, "voted": 16, "icon": "👤" },
    { "name": "Ahmedshaheem", "pts": 12, "voted": 15, "icon": "👤" },
    { "name": "Raaidh", "pts": 12, "voted": 12, "icon": "👤" },
    { "name": "Yusuf", "pts": 11, "voted": 12, "icon": "👤" },
    { "name": "zum", "pts": 9, "voted": 14, "icon": "👤" },
    { "name": "dhaitha", "pts": 8, "voted": 15, "icon": "👤" },
    { "name": "Maadh", "pts": 2, "voted": 3, "icon": "👤" },
    { "name": "Mubeen", "pts": 2, "voted": 4, "icon": "👤" },
    { "name": "Musthafa", "pts": 0, "voted": 0, "icon": "👤" },
    { "name": "Fathun", "pts": 0, "voted": 0, "icon": "👤" },
    { "name": "zaina", "pts": 0, "voted": 0, "icon": "👤" },
    { "name": "Saadhu623", "pts": 0, "voted": 0, "icon": "👤" },
    { "name": "a?/", "pts": 0, "voted": 0, "icon": "👤" },
    { "name": "mal", "pts": 0, "voted": 0, "icon": "👤" },
    { "name": "Nunjaha", "pts": 0, "voted": 0, "icon": "👤" }
];

const staticR16Leaderboard = [
    { "name": "Ikleel", "pts": 9, "voted": 8, "icon": "👑" },
    { "name": "Raaidh", "pts": 8, "voted": 6, "icon": "🥈" },
    { "name": "Nasy", "pts": 7, "voted": 8, "icon": "🥉" },
    { "name": "Azkaan", "pts": 7, "voted": 8, "icon": "👤" },
    { "name": "Ahmedshaheem", "pts": 7, "voted": 8, "icon": "👤" },
    { "name": "zum", "pts": 6, "voted": 8, "icon": "👤" },
    { "name": "Shahuma", "pts": 6, "voted": 8, "icon": "👤" },
    { "name": "Shafga", "pts": 6, "voted": 8, "icon": "👤" },
    { "name": "Mohamed Ashraf", "pts": 6, "voted": 8, "icon": "👤" },
    { "name": "Inaa", "pts": 6, "voted": 8, "icon": "👤" },
    { "name": "Humaid", "pts": 6, "voted": 8, "icon": "👤" },
    { "name": "Asil", "pts": 6, "voted": 8, "icon": "👤" },
    { "name": "Thuhthahtha", "pts": 5, "voted": 8, "icon": "👤" },
    { "name": "Hameed", "pts": 5, "voted": 8, "icon": "👤" },
    { "name": "Azka", "pts": 5, "voted": 8, "icon": "👤" },
    { "name": "Amsoodha", "pts": 5, "voted": 8, "icon": "👤" },
    { "name": "Yusuf", "pts": 5, "voted": 5, "icon": "👤" },
    { "name": "klsm", "pts": 4, "voted": 8, "icon": "👤" },
    { "name": "IyaL", "pts": 4, "voted": 8, "icon": "👤" },
    { "name": "dhaitha", "pts": 4, "voted": 8, "icon": "👤" },
    { "name": "AliAshraf", "pts": 4, "voted": 8, "icon": "👤" },
    { "name": "Elaf", "pts": 4, "voted": 7, "icon": "👤" },
    { "name": "Faiha", "pts": 3, "voted": 8, "icon": "👤" },
    { "name": "Maadh", "pts": 3, "voted": 6, "icon": "👤" },
    { "name": "Faraa", "pts": 3, "voted": 6, "icon": "👤" },
    { "name": "Mubeen", "pts": 1, "voted": 2, "icon": "👤" },
    { "name": "Nukhaam", "pts": 1, "voted": 1, "icon": "👤" },
    { "name": "zaina", "pts": 0, "voted": 0, "icon": "👤" },
    { "name": "Saadhu623", "pts": 0, "voted": 0, "icon": "👤" },
    { "name": "Nunjaha", "pts": 0, "voted": 0, "icon": "👤" },
    { "name": "Musthafa", "pts": 0, "voted": 0, "icon": "👤" },
...
const staticQFLeaderboard = [
    { "name": "IyaL", "pts": 10, "voted": 4, "icon": "👑" },
    { "name": "Maadh", "pts": 9, "voted": 3, "icon": "🥈" },
    { "name": "Thuhthahtha", "pts": 8, "voted": 4, "icon": "🥉" },
    { "name": "Nasy", "pts": 8, "voted": 4, "icon": "🥉" },
    { "name": "Asil", "pts": 8, "voted": 4, "icon": "🥉" },
    { "name": "AliAshraf", "pts": 8, "voted": 4, "icon": "🥉" },
    { "name": "Faraa", "pts": 7, "voted": 3, "icon": "👤" },
    { "name": "Shahuma", "pts": 6, "voted": 4, "icon": "👤" },
    { "name": "Raaidh", "pts": 6, "voted": 4, "icon": "👤" },
    { "name": "Inaa", "pts": 6, "voted": 4, "icon": "👤" },
    { "name": "Humaid", "pts": 6, "voted": 4, "icon": "👤" },
    { "name": "Faiha", "pts": 6, "voted": 4, "icon": "👤" },
    { "name": "Azkaan", "pts": 6, "voted": 4, "icon": "👤" },
    { "name": "Shafga", "pts": 5, "voted": 4, "icon": "👤" },
    { "name": "Ikleel", "pts": 5, "voted": 4, "icon": "👤" },
    { "name": "zaina", "pts": 4, "voted": 4, "icon": "👤" },
    { "name": "Mohamed Ashraf", "pts": 4, "voted": 4, "icon": "👤" },
    { "name": "Hameed", "pts": 4, "voted": 4, "icon": "👤" },
    { "name": "Amsoodha", "pts": 4, "voted": 4, "icon": "👤" },
    { "name": "Ahmedshaheem", "pts": 4, "voted": 4, "icon": "👤" },
    { "name": "klsm", "pts": 3, "voted": 4, "icon": "👤" },
    { "name": "dhaitha", "pts": 3, "voted": 4, "icon": "👤" },
    { "name": "Azka", "pts": 3, "voted": 4, "icon": "👤" },
    { "name": "Elaf", "pts": 2, "voted": 4, "icon": "👤" },
    { "name": "Yusuf", "pts": 2, "voted": 2, "icon": "👤" },
    { "name": "zum", "pts": 1, "voted": 2, "icon": "👤" },
    { "name": "Nukhaam", "pts": 1, "voted": 1, "icon": "👤" },
    { "name": "Saadhu623", "pts": 0, "voted": 0, "icon": "👤" },
    { "name": "Nunjaha", "pts": 0, "voted": 0, "icon": "👤" },
    { "name": "Musthafa", "pts": 0, "voted": 0, "icon": "👤" },
    { "name": "Mubeen", "pts": 0, "voted": 0, "icon": "👤" },
    { "name": "mal", "pts": 0, "voted": 0, "icon": "👤" },
    { "name": "Fathun", "pts": 0, "voted": 0, "icon": "👤" }
];
...
async function renderLeaderboard(type) {
    ...
    const isR32 = currentLeaderboardType === 'r32';
    const isR16 = currentLeaderboardType === 'r16';
    const isQF = currentLeaderboardType === 'qf';
    let combined = [];
    ...
    if (isGroupStage) {
        ...
        combined = staticR32Leaderboard.map(player => ({
            name: player.name === userState.username ? `${player.name} (You)` : player.name,
            pts: player.pts,
            voted: player.voted,
            icon: player.icon || "👤",
        ...
        combined = staticR16Leaderboard.map(player => ({
            name: player.name === userState.username ? `${player.name} (You)` : player.name,
            pts: player.pts,
            voted: player.voted,
            icon: player.icon || "👤",
        ...
        combined = staticQFLeaderboard.map(player => ({
            name: player.name === userState.username ? `${player.name} (You)` : player.name,
            pts: player.pts,
            voted: player.voted,
            icon: player.icon || "👤",
