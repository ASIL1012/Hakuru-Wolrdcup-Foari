...
function getSimulatedNow() {
    ...
    return new Date(BASE_SIMULATED_NOW + elapsed);
}
...
function renderMatches() {
    ...
    upcomingMatches.forEach(match => {
        ...
        const isLocked = (!isToday && !isTomorrow) || isStarted || isPast || match.locked === true;
        ...
        card.innerHTML = `
            <div class="match-info">${match.group} • ${formattedDate} ${formattedTime}</div>
